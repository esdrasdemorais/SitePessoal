...
include_once( ABSPATH . 'wpManut/includes/class-wp-upgrader.php' );
...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		include_once( ABSPATH . 'wpManut/includes/plugin-install.php' ); //for plugins_api..
		...
		include_once( ABSPATH . 'wpManut/includes/theme-install.php' ); //for themes_api..
		 ...
		 * provided in the request for wpManut/update.php. Can be used to
