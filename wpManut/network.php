...
include( ABSPATH . 'wpManut/admin-header.php' );
?>
<div class="wrap">
        ...
        <rewrite>
            <rules>
                ...
                <rule name="WordPress Rule 2" stopProcessing="true">
                    <match url="^' . $iis_subdir_match . 'wpManut$" ignoreCase="false" />
                    <action type="Redirect" url="' . $iis_subdir_replacement . 'wpManut/" redirectType="Permanent" />
                </rule>
...
{$ms_files_rewriting}
# add a trailing slash to /wpManut
RewriteRule ^{$subdir_match}wpManut$ {$subdir_replacement_01}wpManut/ [R=301,L]
...
<?php echo esc_textarea( $htaccess_file ); ?></textarea></li>
	...
	if ( !is_multisite() ) { ?>
		<p><?php printf( __( 'Once you complete these steps, your network is enabled and configured. You will have to log in again.') ); ?> <a href="<?php echo esc_url( site_url( 'wpL.php' ) ); ?>"><?php _e( 'Log In' ); ?></a></p>
<?php
	}
}
...
if ( $_POST ) {
	...
	require_once( ABSPATH . 'wpManut/includes/upgrade.php' );
...
<?php include( ABSPATH . 'wpManut/admin-footer.php' ); ?>
