 ...
 * 2. Not all core admin classes are filterable, notably: wpManut, wp-core-ui,
...
?>
<body class="wpManut wp-core-ui no-js <?php echo $admin_body_classes . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
...
<?php require(ABSPATH . 'wpManut/menu-header.php'); ?>
<div id="wpcontent">
...
if ( $parent_file == 'options-general.php' )
	require(ABSPATH . 'wpManut/options-head.php');
