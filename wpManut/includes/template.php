...
function get_inline_data($post) {
	...
	/** This filter is documented in wpManut/edit-tag-form.php */
	echo '
...
<?php
/** This action is documented in wpManut/admin-header.php */
...
<?php
/** This filter is documented in wpManut/admin-header.php */
$admin_body_classes = apply_filters( 'admin_body_class', '' );
?>
<body<?php if ( isset($GLOBALS['body_id']) ) echo ' id="' . $GLOBALS['body_id'] . '"'; ?> class="wpManut wp-core-ui no-js iframe <?php echo $admin_body_classes . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
//<![CDATA[
(function(){
...
function iframe_footer() {
	...
	<div class="hidden">
<?php
	/** This action is documented in wpManut/admin-footer.php */
...
<html xmlns="http://www.w3.org/1999/xhtml" class="<?php echo $admin_html_class; ?>" <?php
	/** This action is documented in wpManut/includes/template.php */
	do_action( 'admin_xml_ns' );
?> <?php language_attributes(); ?>>
<!--<![endif]-->
<head>
...
function convert_to_screen( $hook_name ) {
	if ( ! class_exists( 'WP_Screen' ) ) {
		_doing_it_wrong( 'convert_to_screen(), add_meta_box()', __( "Likely direct inclusion of wpManut/includes/template.php in order to use add_meta_box(). This is very wrong. Hook the add_meta_box() call into the add_meta_boxes action instead." ), '3.3' );
