...
function unzip_file($file, $to) {
	...
	/** This filter is documented in wpManut/admin.php */
...
function _unzip_file_pclzip($file, $to, $needed_dirs = array()) {
	...
	require_once(ABSPATH . 'wpManut/includes/class-pclzip.php');
...
function WP_Filesystem( $args = false, $context = false, $allow_relaxed_file_ownership = false ) {
	...
	require_once(ABSPATH . 'wpManut/includes/class-wp-filesystem-base.php');
	...
	if ( ! class_exists("WP_Filesystem_$method") ) {
		 ...
		 */
		$abstraction_file = apply_filters( 'filesystem_method_file', ABSPATH . 'wpManut/includes/class-wp-filesystem-' . $method . '.php', $method );
