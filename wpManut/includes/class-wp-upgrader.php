...
require ABSPATH . 'wpManut/includes/class-wp-upgrader-skins.php';
...
class WP_Upgrader {
	...
	public function run( $options ) {
		...
		if ( ! $options['is_multi'] ) {
			...
			/** This action is documented in wpManut/includes/class-wp-upgrader.php */
...
/**
 * Core Upgrader class for WordPress. It allows for WordPress to upgrade itself in combination with the wpManut/includes/update-core.php file
 *
 * @package WordPress
 * @subpackage Upgrader
 * @since 2.8.0
...
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade( $current, $args = array() ) {
		...
		if ( !$wp_filesystem->copy($working_dir . '/wordpress/wpManut/includes/update-core.php', $wp_dir . 'wpManut/includes/update-core.php', true) ) {
			$wp_filesystem->delete($working_dir, true);
			return new WP_Error( 'copy_failed_for_update_core_file', __( 'The update cannot be installed because we will be unable to copy some files. This is usually due to inconsistent file permissions.' ), 'wpManut/includes/update-core.php' );
		}
		$wp_filesystem->chmod($wp_dir . 'wpManut/includes/update-core.php', FS_CHMOD_FILE);

		require_once( ABSPATH . 'wpManut/includes/update-core.php' );
