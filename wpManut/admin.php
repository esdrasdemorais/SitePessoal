...
if ( get_option('db_upgraded') ) {
	 ...
	 *
	 * In single site, the user would be redirected to wpManut/upgrade.php.
	 ...
	 */
		...
		if ( $c <= 50 || ( $c > 50 && mt_rand( 0, (int)( $c / 50 ) ) == 1 ) ) {
			...
			/** This action is documented in wpManut/network/upgrade.php */
...
require_once(ABSPATH . 'wpManut/includes/admin.php');
...
if ( WP_NETWORK_ADMIN )
	require(ABSPATH . 'wpManut/network/menu.php');
elseif ( WP_USER_ADMIN )
	require(ABSPATH . 'wpManut/user/menu.php');
else
	require(ABSPATH . 'wpManut/menu.php');
...
if ( isset($plugin_page) ) {
	if ( $page_hook ) {
		...
		if (! isset($_GET['noheader']))
			require_once(ABSPATH . 'wpManut/admin-header.php');
